...
<div style="margin: 0; padding: 0; display: flex; height: 100vh;">
    ...
    <div style="flex: 2; overflow: hidden; display: flex; justify-content: center; align-items: center; padding: 20px;">
        <i data-plugin="svg" data-svg-src="/assets/images/svg/Error_404.svg" style="width: 75%; height: auto; object-fit: cover;"></i>
    </div>
</div>
